<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="line1" name="line1" type="text" class="mt-1 block w-full" :value="old('address', $user->line1)" required autofocus autocomplete="address" />
            <x-input-error class="mt-2" :messages="$errors->get('address')" />
        </div>

        <div>
            <x-input-label for="line2" :value="__('profile.address-line-2')" />
            <x-text-input id="line2" name="line2" type="text" class="mt-1 block w-full" :value="old('address', $user->line2)" required autofocus autocomplete="address" />
            <x-input-error class="mt-2" :messages="$errors->get('address')" />
        </div>
