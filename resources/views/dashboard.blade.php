<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-zinc dark:bg-zinc-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-zinc dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
                    <div class="p-6 bg-zinc dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg m-8">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-zinc dark:bg-zinc-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
                    <div class="p-6 bg-zinc dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg m-8">
                        <h2 class="text-lg leading-7 font-semibold text-lime-600 dark:text-lime-700">
                            {{ __('40€/month') }}
                        </h2>
                        <p class="mt-2 text-zinc-600 dark:text-zinc-400">{{ __('Just enough to get those basics every month') }}</p>
                    </div>
                    <div class="p-6 bg-zinc dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg m-8">
                        <h2 class="text-lg leading-7 font-semibold text-lime-500 dark:text-lime-600">
                            {{ __('80€/month') }}
                        </h2>
                        <p class="mt-2 text-zinc-600 dark:text-zinc-400">{{ __('Keep your fridge stocked without worry') }}</p>
                    </div>
                    <div class="p-6 bg-zinc dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg m-8">
                        <h2 class="text-lg leading-7 font-semibold text-lime-400 dark:text-lime-400">
                            {{ __('120€/month') }}
                        </h2>
